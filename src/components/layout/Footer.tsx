...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    "Sustainable fashion for the modern professional. Discover curated collections that blend style, comfort, and ethical manufacturing for today's conscious consumer.",
  contactEmail: 'hello@urbanthreads.com',
  contactPhone: '+1 (555) 234-STYLE',
  contactAddress: '456 Fashion District, New York, NY 10018',
  newsletterTitle: 'Style Updates',
  newsletterPlaceholder: 'Enter your email for exclusive offers',
  newsletterDisclaimer:
    'Get early access to new collections and exclusive member discounts. Unsubscribe anytime.',
  section1Title: 'Shop',
  section2Title: 'Company',
  section3Title: 'Support',
  section4Title: 'Legal',
  copyrightText: '© 2024 Urban Threads. All rights reserved.',
  madeWithText: 'with sustainable practices',
  socialText: 'Follow our style:',
  social1Href: 'https://twitter.com/urbanthreads',
  social2Href: 'https://facebook.com/urbanthreads',
  social3Href: 'https://instagram.com/urbanthreads',
  social4Href: 'https://linkedin.com/company/urbanthreads',
  social5Href: 'https://github.com/urbanthreads',
} as const;
