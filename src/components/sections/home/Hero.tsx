...
const DEFAULT_HERO = {
  badge: 'Spring Collection - 30% Off Everything',
  title: 'Sustainable fashion for the',
  titleHighlight: 'modern professional',
  description:
    "Discover Urban Threads' curated collection of eco-conscious fashion designed for today's ambitious professionals. Style that makes a statement while making a difference.",
  features: [
  ...
  primaryCTAHref: '/collections/women',
  ...
  imageAlt: 'Urban Threads sustainable fashion collection',
  statsLabel1: 'Sustainability',
  statsValue1: '100% Ethical',
  statsLabel2: 'Quality',
  statsValue2: 'Premium Fabrics',
} as const;
